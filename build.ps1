...
.\venv\Scripts\pyinstaller --noconfirm --onefile --windowed --icon="icon.ico" --add-data "icon.ico;." --add-data "locales;locales" --hidden-import plyer.platforms.win.notification --name "updater" updater.py
